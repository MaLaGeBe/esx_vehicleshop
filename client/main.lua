...
Citizen.CreateThread(function ()
	...
	ESX.TriggerServerCallback('esx_vehicleshop_lite:getCategories', function (categories)
		Categories = categories
	end)

	ESX.TriggerServerCallback('esx_vehicleshop_lite:getVehicles', function (vehicles)
		Vehicles = vehicles
	end)
end)

RegisterNetEvent('esx_vehicleshop_lite:sendCategories')
AddEventHandler('esx_vehicleshop_lite:sendCategories', function (categories)
	Categories = categories
end)

RegisterNetEvent('esx_vehicleshop_lite:sendVehicles')
AddEventHandler('esx_vehicleshop_lite:sendVehicles', function (vehicles)
	Vehicles = vehicles
end)
...
function OpenShopMenu()
	...
	for i=1, #Vehicles, 1 do
		if IsModelInCdimage(GetHashKey(Vehicles[i].model)) then
			...
			print(('esx_vehicleshop_lite: vehicle "%s" does not exist'):format(Vehicles[i].model))
		end
	end
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'shop_confirm', {
			...
			if data2.current.value == 'yes' then
				local playerData = ESX.GetPlayerData()
					...
					ESX.TriggerServerCallback('esx_vehicleshop_lite:buyVehicle', function (hasEnoughMoney)
						...
						if hasEnoughMoney then
							...
							ESX.Game.SpawnVehicle(vehicleData.model, Config.Zones.ShopOutside.Pos, Config.Zones.ShopOutside.Heading, function (vehicle)
								...
								if Config.EnableOwnedVehicles then
									TriggerServerEvent('esx_vehicleshop_lite:setVehicleOwned', vehicleProps)
								end
...
AddEventHandler('esx_vehicleshop_lite:hasExitedMarker', function (zone)
...
Citizen.CreateThread(function ()
	while true do
		...
		if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
			...
			TriggerEvent('esx_vehicleshop_lite:hasEnteredMarker', currentZone)
		end

		if not isInMarker and HasAlreadyEnteredMarker then
			HasAlreadyEnteredMarker = false
			TriggerEvent('esx_vehicleshop_lite:hasExitedMarker', LastZone)
		end
	end
end)
